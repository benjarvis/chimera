...
"""Minimal standalone NFSv3 + MOUNTv3 client used by the Quint model-based
test harness (replay.py).
...
with chimera's xdrzcc-generated marshalling, so an encoding bug on either
side shows up as a divergence instead of cancelling itself out.  The pynfs
...
class RpcClient:
    ...
    def __init__(self, host, port, prog, vers, timeout=30.0,
                 uid=0, gid=0, machine=b"quintmbt"):
        self.prog = prog
        self.vers = vers
        self.xid = 0x71b00000
        self.uid = uid
